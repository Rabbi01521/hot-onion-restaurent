  ...
  return (
    <div>
      <div className="flex pt-20 flex-col items-center justify-center bg-gray-300 h-screen select-none">
        <div className="flex flex-col -mt-32 bg-white px-4 sm:px-6 md:px-8 lg:px-10 py-8 rounded-xl shadow-2xl w-full max-w-md  border-l-4 border-red-600">
          <div className="font-medium self-center text-xl sm:text-2xl uppercase w-60 text-center bg-red-600 shadow-2xl p-6 rounded-full text-white">
            Log In
          </div>
            ...
            <div>
              ...
              <div className="text-center mt-6">
                <input
                  ...
                  id="signin"
                  value="Log In"
                  className="p-3 rounded-lg bg-red-600 outline-none text-white shadow w-32 justify-center focus:bg-red-700 hover:bg-red-500"
                />
              </div>
              <div className="my-4">
                <div>
